...
<h2>코스별 기본 요금</h2>
<p class="pricing-lead">60·90·120분 코스별 기본 요금입니다. 추가 이동비 발생 여부는 예약 시 위치 기준으로 미리 안내해 드립니다.</p>
...
<p class="price-note">과천시 안에서도 위치와 예약 시간대, 이동 거리에 따라 상담 시 최종 확인됩니다. <a href="/reservation/#payment">결제·이동비 안내 보기 →</a></p>
</section>
"""
